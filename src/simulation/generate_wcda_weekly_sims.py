...
Example Slurm command:
    srun python src/pipeline/wcda_weekly.py --output /path/to/wcda_weekly_sims_full.h5 --nsim 10000 --ncores ${SLURM_CPUS_PER_TASK:-8} --chunk 256 --overwrite
"""
...
DEFAULT_CSV = PROJECT_ROOT / "data" / "raw" / "wcda" / "LHAASO-WCDA_Mrk421_2021-03-08_2025-11-06_week(1).csv"
DEFAULT_OUTPUT = PROJECT_ROOT / "data" / "simulations" / "wcda" / "wcda_weekly_sims_full.h5"
EMMA_PATH = PROJECT_ROOT / "src" / "methods" / "emmanoulopoulos"
