...
```python
# 伪代码
day_to_period = parse_iperiod_h("docs/iPeriod_1Days.h")   # dict[int -> int]
...
1. 输入：`results/LHAASO-WCDA_Mkn421_2021-03-08_2026-03-29_week.csv`
...
- IHEP forward-folding 教程：https://jupyter.ihep.ac.cn/113I0f1xR6S0TBjsgfJV5Q
  （tutorial，必须先读完）
- ETO 端 period 映射源文件：`docs/iPeriod_1Days.h`（1565 行）
...
- ETO 端 WCDA 日 CSV：`results/LHAASO-WCDA_Mkn421_2025-03-29_2026-03-29_day.csv`
